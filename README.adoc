...
You can use this https://start.spring.io/#!type=gradle-project&packaging=jar&language=java&jvmVersion=17&groupId=com.example&artifactId=securing-web&packageName=com.example.securingweb&dependencies=web,thymeleaf[pre-initialized project] and click Generate to download a ZIP file. This project is configured to fit the examples in this tutorial.
...
This line is added to trigger GitHub Actions.
